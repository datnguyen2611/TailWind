<div class="grid grid-cols-1 sm:grid-cols-2 sm:px-8 sm:py-12 sm:gap-x-8 md:py-16">
    ...
    <div class="col-start-1 row-start-3 space-y-3 px-4">
      <p class="flex items-center text-black text-sm font-medium">
        <img src="https://picsum.photos/1000/1000" alt="" class="w-6 h-6 rounded-full mr-2 bg-gray-100">
    ...
    <div class="col-start-1 row-start-1 flex sm:col-start-2 sm:row-span-3">
      <div class="w-full grid grid-cols-3 grid-rows-2 gap-2">
        <div class="relative col-span-3 row-span-2 md:col-span-2">
          <img src="https://picsum.photos/1000/1000" alt="" class="absolute inset-0 w-full h-full object-cover bg-gray-100 sm:rounded-lg" />
        </div>
        <div class="relative hidden md:block">
          <img src="https://picsum.photos/1000/1000" alt="" class="absolute inset-0 w-full h-full object-cover rounded-lg bg-gray-100" />
        </div>
        <div class="relative hidden md:block">
          <img src="https://picsum.photos/1000/1000" alt="" class="absolute inset-0 w-full h-full object-cover rounded-lg bg-gray-100" />
        </div>
  ...
  <p class="text-5xl rounded bg-blue-200">we can do it</p>
